...
public class Constants {
    ...
    public static int NEW_TRANSACTION_ACTIVITY_REQUEST_CODE=1;
    ...
    public static final int DISPLAY_SHOWDAY = 1;
    public static final int DISPLAY_SHOWWEEK = 2;
    public static final int DISPLAY_SHOWMONTH = 3;

    /* DEBUGGING TAGS

        ActivityResults : The results from one activity to another
